...
=======================
  ...
  Basic usage: install this script on a PHP-capable webhost with a URL you trust to not change (such as a web server!), ensure curl is installed, and then configure your local machine to query a specially-formatted URL at intervals:
